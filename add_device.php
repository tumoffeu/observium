...
$options = getopt("i:dhpt");
if (isset($options['i'])) { $snmp_options['poll_id'] = $options['i']; }
...
OPTIONS:
 ...
 -i                                          № instances for multipoller, attribute 'poller_id' in DB(table 'devices')
                                             OST-0, NORD-1, NORD4-2
